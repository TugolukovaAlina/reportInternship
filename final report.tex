...
In the section \ref{sec:Current estimators} we got acquainted with  estimators: Sample average, Volz-Heckathon estimator, Group estimator. 

Volz-Heckathon estimator deals with the problem that random walk visits the nodes with higher degree more frequently. However the problem of homophily remains.
