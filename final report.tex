...
\subsection{Conclusions of the section}
...
On the figure \ref{fig:degree-val66} the correlation between the nodes degree and value for all attributes of two datasets is presented.
