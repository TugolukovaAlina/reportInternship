...
The reasons to study them can be various: studying the prevalence of HIV among the drug users can help to understand and control the spreading of the disease. [put papers that study HIV][why study jazz musicians about improvisation]
...
Targeted sampling tries to 

Another branch is chain-referral techniques.
The researchers are using the fact that people tend to know each other when they have common interests. A jazz musician has a lot of reasons to know another jazz musicians: they may perform in the same clubs, they probably attend the same events, they may collaborate with each other and so on. The researcher use this fact in the following way. They find some representatives of hidden population and then they ask them to provide the contacts of another  member of this population.

These methods of sampling the population are called chain-referral methods. On 
